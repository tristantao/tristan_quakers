...
area=integrate.xy(res[[2]],res[[1]])
jpeg(file="ErrorSMDADiv.jpeg",1200,800)
plot(res[[2]],res[[1]],type="l",lwd=2,cex.axis=1.2,cex.main=1.5,cex.lab=2,main="Error Diagram of Scaled MDA by Division",xlab=expression(tau),ylab=expression(nu))
...
area=integrate.xy(res1[[2]],res1[[1]])
